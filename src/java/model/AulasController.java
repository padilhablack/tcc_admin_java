...
@Named("aulasController")
@SessionScoped
public class AulasController implements Serializable {

    private Aulas current;
    private DataModel items = null;
    @EJB
    private bean.AulasFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Aulas) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("AulasDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Aulas getAulas(java.lang.Integer id) {
        return ejbFacade.find(id);
    }

    @FacesConverter(forClass = Aulas.class)
    public static class AulasControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getAulas(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Aulas) {
                ...
                return getStringKey(o.getIdAulas());
            } else {
